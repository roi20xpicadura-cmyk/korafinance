  ...
  return (
    <section className="relative py-20 md:py-32 px-4 bg-[#0f172a] overflow-hidden">
      <div className="absolute inset-0 -z-0">
        ...
        <div
          className="absolute left-1/4 top-1/4 w-[300px] md:w-[400px] h-[300px] md:h-[400px] rounded-full blur-[80px] md:blur-[100px]"
          style={{ background: 'rgba(124,58,237,0.12)' }}
        />
        <div
          className="absolute right-1/4 bottom-1/4 w-[200px] md:w-[300px] h-[200px] md:h-[300px] rounded-full blur-[60px] md:blur-[80px]"
      ...
      <div className="relative z-10 max-w-[700px] mx-auto text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
          <Link to="/register" className="h-[52px] md:h-[60px] px-8 md:px-10 rounded-2xl bg-[#7C3AED] text-white text-[16px] md:text-[18px] font-[800] hover:bg-[#1A0D35] transition-all duration-200 inline-flex items-center gap-2"
